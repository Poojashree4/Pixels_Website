...
//           <p style={{marginTop:"3px"}}>Search</p>
//         </a>
...
//           <p style={{marginTop:"3px"}}>Profile</p>
//         </a>
//       </header>
...
//               : "linear-gradient(135deg,rgb(186, 214, 242),rgb(231, 234, 237))",
...
//         style={{ width: "150px",height:"235px",borderRadius:"5px",boxShadow:" 0px 3px 3px 3px" }}
//       />  
//       <p>Aladdin</p>
...
//     </div>
//     <div style={{ textAlign: "center" }}>
//       <img src="https://tse4.mm.bing.net/th?id=OIP.AoDOP676ZCg-7xrAQEmnJQHaLe&pid=Api&P=0&h=220"
//         alt="movie poster"
//         style={{ width: "150px",borderRadius:"5px",boxShadow:" 0px 2px 2px 2px" }}
//       />
//       <p>Mersal</p>
//     </div>
//     <div style={{ textAlign: "center" }}>
//       <img src="https://tse3.mm.bing.net/th?id=OIP.7PD7cVpKXxWFzhFKg_qgzgHaJ4&pid=Api&P=0&h=220"
//         alt="movie poster"
//         style={{ width: "160px",height:"235px",borderRadius:"5px",boxShadow:" 0px 2px 2px 2px" }}
//       />
//       <p>Vikram vedha</p>
...
//     </div>
//     <div style={{ textAlign: "center" }}>
//       <img  src="https://tse2.mm.bing.net/th?id=OIP.yYC4T2gMDwioSm2rgFeDwwHaLj&pid=Api&P=0&h=220"
//         alt="movie poster"
//         style={{ width: "150px",borderRadius:"5px",boxShadow:" 0px 2px 2px 2px" }}
//       />
//       <p>Hero</p>
//     </div>
//     <div style={{ textAlign: "center" }}>
//       <img  src="https://tse4.mm.bing.net/th?id=OIP.7JwxELDEkkQEU5eZRP2x_gHaLk&pid=Api&P=0&h=220"
//         alt="movie poster"
//         style={{ width: "150px",borderRadius:"5px",boxShadow:" 0px 2px 2px 2px" }}
//       />
//       <p>Teddy</p>
//     </div>
//     <div style={{ textAlign: "center" }}>
//       <img  src="https://tse1.mm.bing.net/th?id=OIP.HnSyiKz7TWTUpmRdaxVpcgHaK-&pid=Api&P=0&h=220"
//         alt="movie poster"
//         style={{ width: "150px",height:"235px",borderRadius:"5px",boxShadow:" 0px 2px 2px 2px" }}
//       />
//       <p>Comali</p>
//     </div>
//     <div style={{ textAlign: "center" }}>
//       <img src="https://tse4.mm.bing.net/th?id=OIP.xJIqtsBjYbiy5sDvhjFYxQHaKe&pid=Api&P=0&h=220"
//         alt="movie poster"
//         style={{ width: "150px",height:"235px",borderRadius:"5px",boxShadow:" 0px 2px 2px 2px" }}
//       />
//       <p>Kabali</p>
//     </div>
//     <div style={{ textAlign: "center" }}>
//       <img  src="https://tse4.mm.bing.net/th?id=OIP.niyGLlYHRKX2mbwBUokfiAHaKG&pid=Api&P=0&h=220"
//         alt="movie poster"
//         style={{ width: "160px",height:"235px",borderRadius:"5px",boxShadow:" 0px 2px 2px 2px" }}
//       />
//       <p>Kana</p>
...
// </div>
//     </div> */}
  // New route to fetch movie data from MongoDB
// app.get("/maindata", async (req, res) => {
//     try {
//       const client = await connect();
//       const mainDataCol = client.db("Logindetails").collection("maindata");
      
//       // Fetch all movie data
//       const movies = await mainDataCol.find().toArray();
