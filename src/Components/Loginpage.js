    ...
    <div className="container">
      ...
      <div className="right-section">
        ...
        <form className="form" onSubmit={handleSubmit}>
          <h4 style={{ marginLeft: "30px", marginTop: "10px" }}>
          ...
          <input
            ...
            required
          />
          <a href="#" className="forgpass" style={{color:"white",fontSize:"13px"}}>
            Forget password?
          </a>
          <br />
          <div>
          ...
          <a href="#" className="create-acc" style={{color:"white",fontSize:"13px"}} onClick={registerClick}>
            Create Account
          </a>
        </form>
        {message && <p>{message}</p>}
